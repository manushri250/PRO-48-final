...
var zk = 15;
var lives = 15;
var lifeImg, life, coino, coinoImg, invi, inviImg, zkk, zkkImg, fight, fightImg, boyEnd, boyEndImg;
...
function preload(){
 ...
 boyEndImg = loadImage("images/boyEnd.png");
}
...
console.log(player.x);
  ...
  Coin1Group.setVelocityXEach(0);
    ...
    player.changeAnimation("end",boyEnd);
